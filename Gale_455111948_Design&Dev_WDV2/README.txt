...
4: Navigation <nav> elements defined for every user type

5: Three examples of a form submitting through relevant controller

6: One example of CRUD implemented

7: Three controllers exiting back to relevant user view


  PART C - DEBUG

8: Error DIV & Message DIV defined in layout

9: Debug information DIV in footer, echo $_SESSION info



  PART D - HOSTED VERSION CONTROL

9: Code commits (ten) made to a version control system
