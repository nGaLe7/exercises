    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Autocorrect example inside modal</p>

        <form autocomplete="off" action="addform.php">
        <div class="autocomplete" style="width:300px;">
        <input id="myInput" type="text" name="myCountry" autocomplete="off" placeholder="Country">
        </div>
        <input type="submit">
        </form>
        </div>
...
<div height="400px" width="400px" id="divMessage">placeholder text</div>
<div>

<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
 <fieldset>
    <legend>PHP Validation</legend>
    <label>Name:</label> <input type="text" name="valName">  
    <label>E-mail:</label> <input type="text" name="valEmail">  
    <label>Website:</label> <input type="text" name="valWebsite"> 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $name = test_input($_POST["valName"]);
  $email = test_input($_POST["valEmail"]);
  $website = test_input($_POST["valWebsite"]);
